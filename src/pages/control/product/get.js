...
const ProductControlGet = () => {
  ...
  useEffect(() => {
    ...
    // getData("/admin/control-products?page=" + currentPage);

    if (myQuery) {
      getData("/admin/control-products?page=" + currentPage + "&" + myQuery);
    } else {
      getData("/admin/control-products?page=" + currentPage);
    }
  ...
  const redirectHandler = async (controlId) => {
    await axiosInstance
      .get("/admin/control-products/redirect/" + controlId)
      .then((res) => {
  ...
  const checkHandler = async (controlId) => {
    await axiosInstance
      .get("/admin/control-products/check/" + controlId)
      .then((res) => {
          ...
          <table className="table">
            <thead>
              <tr>
                ...
                <th scope="col">Old Product Slug</th>
                    ...
                    <td className="white-space-nowrap">
                      ...
                      control.newSlug ? (
                        <>
                          ...
                          <Link
                            className="me-3"
                            to={"/control-products/" + control._id}
                          >
...
export default ProductControlGet;
