...
const BrandControlEdit = () => {
  ...
  useEffect(() => {
    getData("/admin/control-brands/" + _id);
  }, [getData, _id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosInstance.put("/admin/control-brands/" + _id, formData);
      setLoading(false);
      toast.success("Updated Successfully.");
      navigate("/control-brands");
    } catch (error) {
      console.log(error);
...
export default BrandControlEdit;
