...
const CategoryControlEdit = () => {
  ...
  useEffect(() => {
    getData("/admin/control-categories/" + _id);
  }, [getData, _id]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axiosInstance.put("/admin/control-categories/" + _id, formData);
      setLoading(false);
...
export default CategoryControlEdit;
