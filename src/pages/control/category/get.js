...
const CategoryControlGet = () => {
  ...
  useEffect(() => {
    ...
    // getData("/admin/control-categories?page=" + currentPage);

    if (myQuery) {
      getData("/admin/control-categories?page=" + currentPage + "&" + myQuery);
    } else {
      getData("/admin/control-categories?page=" + currentPage);
    }
  ...
  const redirectHandler = async (controlId) => {
    await axiosInstance
      .get("/admin/control-categories/redirect/" + controlId)
      .then((res) => {
  ...
  const checkHandler = async (controlId) => {
    await axiosInstance
      .get("/admin/control-categories/check/" + controlId)
      .then((res) => {
        ...
        <div className="scroll-x mt-4">
          ...
          <table className="table">
            <thead>
              <tr>
                <th scope="col">#</th>
                <th scope="col">Old Category Title</th>
                <th scope="col">Old Category Slug</th>
                <th scope="col">New Category Title</th>
                <th scope="col">New Category Slug</th>
                    ...
                    <td className="white-space-nowrap">
                      ...
                      control.newSlug ? (
                        <>
                          ...
                          <Link
                            className="me-3"
                            to={"/control-categories/" + control._id}
                          >
...
export default CategoryControlGet;
